...
namespace OkOceanFisheries.Controllers
{
    ...
    public ApplicationSignInManager SignInManager
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register([Bind(Include = "EmployeeId,FirstName,LastName,Contact,Position,Email,HourlyWage")] Employee employee)
        {
            if (ModelState.IsValid)
            {
